...
//    Manifest.permission.READ_PHONE_STATE
    ...
    protected void onResume() {
        ...
        if (startCheckPermissions(needPermissions)) {
            isNeedCheck = false;
            if (alertDialog!=null){
                alertDialog.dismiss();
                alertDialog=null;
...
//        LogUtils.toE("isNeedCheck", "" + isNeedCheck);
        if (isNeedCheck) {
    ...
    private boolean startCheckPermissions(String[] needPermissions) {
...
//            }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        LogUtils.toE("paramArrayOfInt", "" + verifyPermissions(paramArrayOfInt));
        if (requestCode == PERMISSON_REQUESTCODE) {
            LogUtils.toE("paramArrayOfInt1", "" + verifyPermissions(paramArrayOfInt));
