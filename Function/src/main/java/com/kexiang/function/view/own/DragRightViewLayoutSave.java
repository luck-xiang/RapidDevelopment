...
public class DragRightViewLayoutSave extends ViewGroup
//        implements View.OnTouchListener
{
    public DragRightViewLayoutSave(Context context) {
        super(context);
    }
...
//    }
//
//    public DragRightViewLayoutSave(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        initView(context);
//        initType(context, attrs);
//    }
//
//    public DragRightViewLayoutSave(Context context, AttributeSet attrs, int defStyleAttr) {
